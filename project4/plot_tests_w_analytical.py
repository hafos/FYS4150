...
ax[0,1].plot(T[i1:i2], m[i1:i2], '+', label='Computed')
ax[0,1].plot(T[i2:], m[i2:], '+', label='Computed')
ax[0,1].set_xlabel(r'T [J/k$_B$]')
ax[0,1].set_ylabel(r'$|m|$ [1]')

ax[1,0].plot(temp, exp_Cv(temp))
ax[1,0].plot(T[:i1], Cv[:i1], '+', label='Computed')
ax[1,0].plot(T[i1:i2], Cv[i1:i2], '+', label='Computed')
ax[1,0].plot(T[i2:], Cv[i2:], '+', label='Computed')
ax[1,0].set_xlabel(r'T [J/k$_B$]')
ax[1,0].set_ylabel(r'$C_V$ [k$_B$]')

ax[1,1].plot(temp, exp_X(temp))
ax[1,1].plot(T[:i1], X[:i1], '+', label='Computed')
ax[1,1].plot(T[i1:i2], X[i1:i2], '+', label='Computed')
ax[1,1].plot(T[i2:], X[i2:], '+', label='Computed')
